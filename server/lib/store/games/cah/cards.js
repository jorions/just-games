...
module.exports = {
  blackCards: [
    { text: "Why can't I sleep at night?", pick: 2 },
    { text: "I got 99 problems but _ ain't one.", pick: 2 },
    { text: "What's a girl's best friend?", pick: 2 },
    { text: "What's that smell?", pick: 2 },
    {
      text:
        'This is the way the world ends / This is the way the world ends / Not with a bang but with _.',
      pick: 2,
    },
    { text: "What is Batman's guilty pleasure?", pick: 2 },
    { text: 'TSA guidelines now prohibit _ on airplanes.', pick: 2 },
    { text: 'What ended my last relationship?', pick: 2 },
    { text: "MTV's new reality show features eight washed-up celebrities living with _.", pick: 2 },
    { text: 'I drink to forget _.', pick: 2 },
    { text: "I'm sorry, Professor, but I couldn't complete my homework because of _.", pick: 2 },
    { text: 'Alternative medicine is now embracing the curative powers of _.', pick: 2 },
    { text: "What's that sound?", pick: 2 },
    { text: "What's the next Happy Meal&reg; toy?", pick: 2 },
    { text: "It's a pity that kids these days are all getting involved with _.", pick: 2 },
    {
      text:
        'In the new Disney Channel Original Movie, Hannah Montana struggles with _ for the first time.',
      pick: 2,
    },
    { text: "_. That's how I want to die.", pick: 2 },
    { text: 'What does Dick Cheney prefer?', pick: 2 },
    { text: "What's the most emo?", pick: 2 },
    { text: 'Instead of coal, Santa now gives the bad children _.', pick: 2 },
    { text: 'Next from J.K. Rowling: Harry Potter and the Chamber of _.', pick: 2 },
    { text: 'A romantic, candlelit dinner would be incomplete without _.', pick: 2 },
    { text: 'White people like _.', pick: 2 },
    { text: "_. Betcha can't have just one!", pick: 2 },
    { text: 'War!<br><br>What is it good for?', pick: 2 },
    { text: 'BILLY MAYS HERE FOR _.', pick: 2 },
    { text: '_. High five, bro.', pick: 2 },
    { text: 'During sex, I like to think about _.', pick: 2 },
    { text: 'What did I bring back from Mexico?', pick: 2 },
    { text: 'What are my parents hiding from me?', pick: 2 },
    { text: 'What will always get you laid?', pick: 2 },
    { text: 'What would grandma find disturbing, yet oddly charming?', pick: 2 },
    { text: 'What did the U.S. airdrop to the children of Afghanistan?', pick: 2 },
    { text: 'What helps Obama unwind?', pick: 2 },
    { text: "What's there a ton of in heaven?", pick: 2 },
    { text: 'Major League Baseball has banned _ for giving players an unfair advantage.', pick: 2 },
    { text: 'When I am a billionaire, I shall erect a 50-foot statue to commemorate _.', pick: 2 },
    { text: "What's the new fad diet?", pick: 2 },
    {
      text: 'When I am the President of the United States, I will create the Department of _.',
      pick: 2,
    },
    { text: "_. It's a trap!", pick: 2 },
    { text: 'How am I maintaining my relationship status?', pick: 2 },
    {
    ...
    { text: 'Coming to Broadway this season, _: The Musical.', pick: 2 },
    { text: "What's my secret power?", pick: 2 },
    { text: 'What gives me uncontrollable gas?', pick: 2 },
    { text: 'But before I kill you, Mr. Bond, I must show you _.', pick: 2 },
    { text: 'What never fails to liven up the party?', pick: 2 },
    { text: 'What am I giving up for Lent?', pick: 2 },
    { text: 'What do old people smell like? ', pick: 2 },
    { text: 'The class field trip was completely ruined by _.', pick: 2 },
    { text: 'When Pharaoh remained unmoved, Moses called down a plague of _.', pick: 2 },
    {
      text:
        'I do not know with which weapons World War III will be fought, but World War IV will be fought with _.',
      pick: 2,
    },
    { text: "What's Teach for America using to inspire inner city students to succeed?", pick: 2 },
    { text: "In Michael Jackson's final moments, he thought about _.", pick: 2 },
    { text: 'Why do I hurt all over?', pick: 2 },
    {
      text: 'Studies show that lab rats navigate mazes 50% faster after being exposed to _.',
      pick: 2,
    },
    { text: 'Why am I sticky?', pick: 2 },
    { text: "What's my anti-drug?", pick: 2 },
    { text: 'And the Academy Award for _ goes to _.', pick: 2 },
    { text: 'For my next trick, I will pull _ out of _.', pick: 2 },
    { text: '_: Good to the last drop.', pick: 2 },
    { text: 'What did Vin Diesel eat for dinner?', pick: 2 },
    { text: '_: kid-tested, mother-approved.', pick: 2 },
    { text: 'What gets better with age?', pick: 2 },
    ...
    { text: 'After the earthquake, Sean Penn brought _ to the people of Haiti.', pick: 2 },
    { text: 'In L.A. County Jail, word is you can trade 200 cigarettes for _.', pick: 2 },
    { text: "Maybe she's born with it. Maybe it's _.", pick: 2 },
    {
      text:
        'Life for American Indians was forever changed when the White Man introduced them to _.',
      pick: 2,
    },
    { text: 'Next on ESPN2, the World Series of _.', pick: 2 },
    ...
    { text: 'How did I lose my virginity?', pick: 2 },
    {
    ...
    { text: "What don't you want to find in your Kung Pao chicken?", pick: 2 },
    { text: 'The Smithsonian Museum of Natural History has just opened an exhibit on _.', pick: 2 },
    { text: 'Daddy, why is Mommy crying?', pick: 2 },
    { text: 'What brought the orgy to a grinding halt?', pick: 2 },
    { text: 'When I pooped, what came out of my butt?', pick: 2 },
    {
      text:
        "In the distant future, historians will agree that _ marked the beginning of America's decline.",
      pick: 2,
    },
    { text: "What's the gift that keeps on giving?", pick: 2 },
    {
      text:
    ...
    { text: "And I would have gotten away with it, too, if it hadn't been for _!", pick: 2 },
    { text: 'In a pinch, _ can be a suitable substitute for _.', pick: 2 },
    { text: 'What has been making life difficult at the nudist colony?', pick: 2 },
    { text: 'Science will never explain the origin of _.', pick: 2 },
    {
      text: 'In Rome, there are whisperings that the Vatican has a secret room devoted to _.',
      pick: 2,
    },
    { text: "I learned the hard way that you can't cheer up a grieving friend with _.", pick: 2 },
    { text: 'When all else fails, I can always masturbate to _.', pick: 2 },
    ...
    { text: 'In his new self-produced album, Kanye West raps over the sounds of _.', pick: 2 },
    {
      text:
        'The socialist governments of Scandinavia have declared that access to _ is a basic human right.',
      pick: 2,
    },
    { text: 'He who controls _ controls the world.', pick: 2 },
    {
      text:
        'Dear Sir or Madam, We regret to inform you that the Office of _ has denied your request for _.',
      pick: 2,
    },
    { text: 'The CIA now interrogates enemy agents by repeatedly subjecting them to _.', pick: 2 },
    { text: '_ would be woefully incomplete without _.', pick: 2 },
    { text: 'During his midlife crisis, my dad got really into _.', pick: 2 },
    {
      text: 'Before I run for president, I must destroy all evidence of my involvement with _.',
      pick: 2,
    },
    { text: 'My new favorite porn star is Joey "_" McGee.', pick: 2 },
    { text: 'In his newest and most difficult stunt, David Blaine must escape from _.', pick: 2 },
    { text: 'This is your captain speaking. Fasten your seatbelts and prepare for _.', pick: 2 },
    {
      text: 'My mom freaked out when she looked at my browser history and found _.com/_.',
      pick: 2,
    },
    { text: 'The Five Stages of Grief: denial, anger, bargaining, _, acceptance.', pick: 2 },
    {
      text:
    ...
    { text: 'Little Miss Muffet Sat on a tuffet, Eating her curds and _.', pick: 2 },
    {
    ...
    { text: "My country, 'tis of thee, sweet land of _.", pick: 2 },
    {
      text:
    ...
    { text: 'Next time on Dr. Phil: How to talk to your child about _.', pick: 2 },
    { text: 'Only two things in life are certain: death and _.', pick: 2 },
    {
      text: "Everyone down on the ground! We don't want to hurt anyone. We're just here for _.",
      pick: 2,
    },
    { text: 'The healing process began when I joined a support group for victims of _.', pick: 2 },
    { text: 'The votes are in, and the new high school mascot is _.', pick: 2 },
    { text: 'Charades was ruined for me forever when my mom had to act out _.', pick: 2 },
    { text: 'Before _, all we had was _.', pick: 2 },
    { text: "Tonight on 20/20: What you don't know about _ could kill you.", pick: 2 },
    { text: "You haven't truly lived until you've experienced _ and _ at the same time.", pick: 2 },
    { text: "Hey baby, come back to my place and I'll show you _.", pick: 2 },
    { text: 'My gym teacher got fired for adding _ to the obstacle course.', pick: 2 },
    { text: 'Finally! A service that delivers _ right to your door.', pick: 2 },
    {
      text:
    ...
    { text: 'During high school, I never really fit in until I found _ club.', pick: 2 },
    { text: "Money can't buy me love, but it can buy me _.", pick: 2 },
    {
      text:
        "Listen, son. If you want to get involved with _, I won't stop you. Just steer clear of _.",
      pick: 2,
    },
    { text: 'A successful job interview begins with a firm handshake and ends with _.', pick: 2 },
    {
      text:
        'Call the law offices of Goldstein &amp; Goldstein, because no one should have to tolerate _ in the workplace.',
      pick: 2,
    },
    { text: "Lovin' you is easy 'cause you're _.", pick: 2 },
    {
      text: 'The blind date was going horribly until we discovered our shared interest in _.',
      pick: 2,
    },
    { text: 'What left this stain on my couch?', pick: 2 },
    { text: 'Turns out that _-Man was neither the hero we needed nor wanted.', pick: 2 },
    { text: "After months of practice with _, I think I'm finally ready for _.", pick: 2 },
    { text: 'In the seventh circle of Hell, sinners must endure _ for all eternity.', pick: 2 },
    { text: 'As part of his daily regimen, Anderson Cooper sets aside 15 minutes for _.', pick: 2 },
    { text: 'When you get right down to it, _ is just _.', pick: 2 },
    { text: 'Having problems with _? Try _!', pick: 2 },
    { text: 'And what did <i>you</i> bring for show and tell?', pick: 2 },
    { text: "I'm not like the rest of you. I'm too rich and busy for _.", pick: 2 },
    { text: 'With enough time and pressure, _ will turn into _.', pick: 2 },
    { text: '_: Hours of fun. Easy to use. Perfect for _!', pick: 2 },
    { text: '_. Awesome in theory, kind of a mess in practice.', pick: 2 },
    {
      text: "As part of his contract, Prince won't perform without _ in his dressing room.",
      pick: 2,
    },
    { text: 'Man, this is bullshit. Fuck _.', pick: 2 },
    {
      text:
    ...
    { text: "She's up all night for good fun.<br>I'm up all night for _.", pick: 2 },
    {
      text:
    ...
    { text: 'The Japanese have developed a smaller, more efficient version of _.', pick: 2 },
    ...
    { text: "What's fun until it gets weird?", pick: 2 },
    ...
    { text: 'How am I compensating for my tiny penis?', pick: 2 },
    { text: "I'm sorry, sir, but we don't allow _ at the country club.", pick: 2 },
    {
      text:
    ...
    { text: 'As king, how will I keep the peasants in line?', pick: 2 },
    { text: 'Oprah\'s book of the month is "_ For _: A Story of Hope."', pick: 2 },
    { text: 'Do <i>not</i> fuck with me! I am literally _ right now.', pick: 2 },
    ...
    { text: "This is the prime of my life. I'm young, hot, and full of _.", pick: 2 },
    {
    ...
    { text: "I don't mean to brag, but they call me the Michael Jordan of _.", pick: 2 },
    { text: 'Why am I broke?', pick: 2 },
    { text: "Help me doctor, I've got _ in my butt!", pick: 2 },
    {
      text:
    ...
    { text: 'What killed my boner?', pick: 2 },
    { text: "Yo' mama so fat she _!", pick: 2 },
    ...
    { text: 'WHOOO! God damn I love _!', pick: 2 },
    { text: 'Now in bookstores: "The Audacity of _", by Barack Obama.', pick: 2 },
    { text: "And today's soup is Cream of _.", pick: 2 },
    {
      pick: 2,
    ...
    { pick: 2, text: 'And would you like those buffalo wings mild, hot, or _?' },
    {
      pick: 2,
      text:
        'The six things I could never do without: oxygen, Facebook, chocolate, Netflix, friends, and _ LOL!',
    },
    { pick: 2, text: "Why won't you make love to me anymore? Is it _?" },
    {
      pick: 2,
      text:
    ...
    { pick: 2, text: "Art isn't just a painting in a stuffy museum. Art is alive. Art is _." },
    { pick: 2, text: 'As reparations for slavery, all African Americans will receive _.' },
    {
      pick: 2,
      text:
    ...
    { pick: 2, text: 'CNN breaking news! Scientists discover _.' },
    { pick: 2, text: 'Coming to Red Lobster&reg; this month, _.' },
    {
      pick: 2,
      text:
    ...
    { pick: 2, text: 'Errbody in the club _.' },
    { pick: 2, text: 'Feeling so grateful! #amazing #mylife #_.' },
    { pick: 2, text: 'Girls just wanna have _.' },
    { pick: 2, text: 'Google Calendar alert: _ in 10 minutes.' },
    { pick: 2, text: "I don't believe in God. I believe in _." },
    { pick: 2, text: "I got rhythm, I've got music, I've got _. Who could ask for anything more?" },
    { pick: 2, text: 'I may not be much to look at, but I fuck like _.' },
    {
      pick: 2,
      text: 'I tell you, it was a non-stop fuckfest. When it was over, my asshole looked like _.',
    },
    { pick: 2, text: "I'll take the BBQ bacon burger with friend egg and fuck it how about _." },
    {
      pick: 2,
    ...
    { pick: 2, text: "If at first you don't succeed, try _." },
    { pick: 2, text: 'In the 1950s, psychologists prescribed _ as a cure for homosexually.' },
    { pick: 2, text: 'LSD + _ = really bad time.' },
    {
      pick: 2,
      text: '"Mom\'s to-do list:<br/>- Buy Groceries.<br/>- Clean up _.<br/>- Soccer Practice."',
    },
    { pick: 2, text: 'Most Americans would not vote for a candidate who is openly _.' },
    { pick: 2, text: 'No, no, no, no, no, no, NO! I will NOT let _ ruin this wedding.' },
    { pick: 2, text: 'Oh no! Siri, how do I fix _?' },
    { pick: 2, text: 'One more thing. Watch out for Big Mike. They say he killed a man with _.' },
    { pick: 2, text: 'Ooo, daddy like _.' },
    {
      pick: 2,
      text: "Poor Brandon, still living in his parent's basement. I heard he never got over _.",
    },
    { pick: 2, text: "Run, run, as fast as you can! You can't catch me, I'm _!" },
    { pick: 2, text: "She's a lady in the streets, _ in the sheets." },
    { pick: 2, text: "She's just one of the guys, you know? She likes beer, and football, and _." },
    {
      pick: 2,
      text:
        "Son, take it from someone who's been around the block a few times. Nothin' puts her in the mood like _.",
    },
    { pick: 2, text: "Summer lovin', had me a blast. _, happened so fast." },
    {
      pick: 2,
      text:
        '"The top Google auto-complete results for "Barack Obama":</br>- Barack Obama Height.</br>- Barack Obama net worth.</br>- Barack Obama _."',
    },
    { pick: 2, text: 'Then the princess kissed the frog, and all of a sudden the frog was _!' },
    { pick: 2, text: "There is no God. It's just _ and then you die." },
    { pick: 2, text: "This Friday at the Liquid Lunge, it's _ Night! Ladies drink free." },
    {
      pick: 2,
      text: 'We do not shake with our left hands in this country. That is the hand we use for _.',
    },
    { pick: 2, text: 'Well if _ is a crime, then lock me up!' },
    {
      pick: 2,
      text: "Well, shit. My eyes ain't so good, but I'll eat my own boot if that ain't _!",
    },
    { pick: 2, text: 'What are all those whales singing about?' },
    { pick: 2, text: 'What sucks balls?' },
    { pick: 2, text: 'What totally destroyed my asshole?' },
    { pick: 2, text: 'What turned me into a Republican?' },
    { pick: 2, text: 'What will end racism once and for all?' },
    { pick: 2, text: "What's a total waste of Hillary Clinton's time?" },
    { pick: 2, text: "What's about to take dance floor to the next level?" },
    { pick: 2, text: "What's the gayest?" },
    { pick: 2, text: "What's the most problematic?" },
    { pick: 2, text: 'Why am I laughing and crying and taking off my clothes?' },
    { pick: 2, text: 'With a one-time gift of just $10, you can save this child from _.' },
    { pick: 2, text: 'You know who else liked _? Hitler.' },
    { pick: 2, text: "You won't believe what's in my pussy. It's _." },
    {
      text: 'Siskel and Ebert have panned _ as "poorly conceived" and "sloppily executed."',
      pick: 2,
    },
    { text: 'Up next on Nickelodeon: "Clarissa Explains _."', pick: 2 },
    { text: 'Believe it or not, Jim Carrey can do a dead-on impression of _.', pick: 2 },
    {
      text: "It's Morphin' Time! Mastadon! Pterodactyl! Triceratops! Sabertooth Tiger! _!",
      pick: 2,
    },
    { text: "I'm a bitch, I'm a lover, I'm a child, I'm _.", pick: 2 },
    { text: 'How did Stella get her groove back?', pick: 2 },
    { text: 'Tonight on SNICK: "Are You Afraid of _?"', pick: 2 },
  ],
  whiteCards: [
  ...
  '90s': {
    ...
    black: [295, 296, 297, 298, 299, 300, 301],
    white: [
      1155,
      1156,
      1157,
  ...
  order: ['Base', 'CAHe1', 'CAHe2', 'CAHe3', 'CAHe4', 'CAHe5', 'CAHe6', 'greenbox', '90s'],
}
