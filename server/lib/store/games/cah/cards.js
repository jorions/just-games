...
module.exports = {
  blackCards: [
    ...
    { pick: 1, text: "Art isn't just a painting in a stuffy museum. Art is alive. Art is _." },
    ...
    { pick: 1, text: "I got rhythm, I've got music, I've got _. Who could ask for anything more?" },
    ...
    { pick: 1, text: "I'll take the BBQ bacon burger with friend egg and fuck it how about _." },
    {
      pick: 1,
    ...
    { pick: 1, text: 'In the 1950s, psychologists prescribed _ as a cure for homosexually.' },
    { pick: 1, text: 'LSD + _ = really bad time.' },
    {
      pick: 1,
      text: '"Mom\'s to-do list:<br/>- Buy Groceries.<br/>- Clean up _.<br/>- Soccer Practice."',
    },
    { pick: 1, text: 'Most Americans would not vote for a candidate who is openly _.' },
    { pick: 1, text: 'No, no, no, no, no, no, NO! I will NOT let _ ruin this wedding.' },
    { pick: 1, text: 'Oh no! Siri, how do I fix _?' },
    { pick: 1, text: 'One more thing. Watch out for Big Mike. They say he killed a man with _.' },
    { pick: 1, text: 'Ooo, daddy like _.' },
    {
      pick: 1,
      text: "Poor Brandon, still living in his parent's basement. I heard he never got over _.",
    },
    { pick: 1, text: "Run, run, as fast as you can! You can't catch me, I'm _!" },
    { pick: 1, text: "She's a lady in the streets, _ in the sheets." },
    { pick: 1, text: "She's just one of the guys, you know? She likes beer, and football, and _." },
    {
      pick: 1,
      text:
    ...
    { pick: 1, text: 'Then the princess kissed the frog, and all of a sudden the frog was _!' },
    { pick: 1, text: "There is no God. It's just _ and then you die." },
    { pick: 1, text: "This Friday at the Liquid Lounge, it's _ Night! Ladies drink free." },
    {
      pick: 1,
    ...
    { pick: 1, text: 'Why am I laughing and crying and taking off my clothes?' },
    { pick: 1, text: 'With a one-time gift of just $10, you can save this child from _.' },
